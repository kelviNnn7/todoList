...
import { Bell, BellRing, ChevronDown, ChevronRight, Clock3, MapPin, Trash2, Video } from "lucide-react";
...
interface Props { item: TodoItem; autoExpand?: boolean; onChange: (item: TodoItem) => Promise<void>; onDelete: (id: string) => Promise<void> }

export function ItemCard({ item, autoExpand = false, onChange, onDelete }: Props) {
