...
| I-035 | v0.3.3 日期自动定位 | 周/月界面跟随系统日期展示当前周和当前月，待办自动切换至当日 | 启动、跨日、前台恢复、周/月切换及紧凑/展开切换时统一定位系统当天；当前日期内保留手动浏览能力 | FR-005、FR-029 | dev 已实现；自动化覆盖周界、月界和视图切换回当天，待安装包与三平台真机验收 |
